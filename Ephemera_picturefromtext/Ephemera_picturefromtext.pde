...
void draw() {
  //TURN THIS INTO A FUNCTION: x,y,loc,r,g,b, fill, text
  // Pick a random point
  ...
  //// Draw an random character at that location with that color
  fill(r,g,b,100);
  text(" " + char(int(random(33, 127))),x,y);
  fill(r2,g2,b2,100);
  text(" " + char(int(random(33, 127))),x2,y2);
  fill(r3,g3,b3,100);
  text(" " + char(int(random(33, 127))),x3,y3);
  fill(r4,g4,b4,100);
  text(" " + char(int(random(33, 127))),x3,y3);
  fill(r5,g5,b5,100);
  text(" " + char(int(random(33, 127))),x3,y3);
