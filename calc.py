...
button_add = Button(root, text="+", padx=39, pady=20, bg="sky blue", command=button_add)
button_equal = Button(root, text="=", padx=38, pady=20, bg="yellow", command=button_equal)
button_clear = Button(root, text="Clear", padx=30, pady=20, bg="red", command=button_clear)
button_sqrt = Button(root, text="Sqrt ", padx=31, pady=20, bg="red", command=button_sqrt)
button_percent = Button(root, text="%", padx=38, pady=20, bg="red", command=button_percent)
button_subtract = Button(root, text="-", padx=40, pady=20, bg="sky blue", command=button_subtract)
button_multiply = Button(root, text="*", padx=40, pady=20, bg="sky blue", command=button_multiply)
...
button_equal.grid(row=6, column=2) #columnspan() to make wider
